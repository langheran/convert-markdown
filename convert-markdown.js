...
const currentModuleUrl = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('convert-markdown.js', document.baseURI).href));
const currentModulePath = url.fileURLToPath(currentModuleUrl);
const currentModuleDir = (process.pkg) ? process.cwd():path.dirname(currentModulePath);
...
commander.program.action(async (text, options) => {
  // Read from stdin
